metadata = {
    ...
    'prior_card_surg_type_tcr': {
        'name_long': 'Prior cardiac surgery type recipient',
        'type': 'recipient',
        'value_map': {
            4.0: 'Congenital',
            22.0: 'Valve',
    ...
    'diag': {
        'name_long': 'Thoracic diagnosis recipient (listing)',
        'type': 'recipient'
    },
    'dial_prior_tx': {
    ...
    'distance': {
        'name_long': 'Distance between centers',
        'type': 'matching',
    },
    ...
    'vessels_50sten': {
        'name_long': 'Vessels with stenosis donor',
        'type': 'donor'
    },
    'biopsy_dgn': {
    ...
    'ecd_donor': {
        'name_long': 'ECCT criteria for donor',
        'type': 'donor',
        'na_values': ['U', 'PD', 'C'],
        'value_map': {
            0: 'N',
    ...
    'pvr': {
        'name_long': 'Pulmonary vascular resistances',
        'type': 'recipient'
    },
    'anyvent': {
